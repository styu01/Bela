...
export function initDatabase(dbPathOverride?: string): void {
  ...
  // Stage-2 escalation stamp (direct-to-owner Telegram alert), added
  // 2026-08-29 alongside the two-step escalation redesign -- see
  // docs/scheduler-escalation-dev-spec.md. Mirrors alert_sent_at exactly
  // (claim-before-send guard, cleared on delivery failure), just for the
  // later, bigger threshold.
